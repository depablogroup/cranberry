...
- The current public surface includes `cranberry inspect`, `cranberry energy`, and `cranberry md`.
...
The next major user-facing work is Phase 4:

- preparation/coarse-graining workflow
- canonical CG input handling
- optional 5'-terminal phosphate insertion
